...
describe("OrangeHRM Login", () => {
  it("should log in successfully", () => {
    ...
    cy.get(
      ":nth-child(3) > .orangehrm-post-comment > .orangehrm-post-comment-action-area > :nth-child(2)"
    ).click();
    cy.get(
      ".orangehrm-post-comment > .oxd-form > .oxd-input-group > :nth-child(2) > .oxd-input"
    ).clear();
    cy.get(
      ".orangehrm-post-comment > .oxd-form > .oxd-input-group > :nth-child(2) > .oxd-input"
    ).type("Osthire{enter}");
